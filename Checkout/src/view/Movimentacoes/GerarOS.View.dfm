object FRM_ADD_OS: TFRM_ADD_OS
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object P_CONTAINER_ADDOS: TPanel
    Left = 0
    Top = 0
    Width = 641
    Height = 553
    ...
    object P_RODAPE: TPanel
      ...
      object SB_FINALIZAR: TSpeedButton
        Left = -1
        Top = 8
        Width = 126
        Height = 38
    ...
    object P_TOPO: TPanel
      ...
      object EDT_TECRESPONSAVEL: TEdit
        Left = 320
        Top = 56
        Width = 265
        Height = 21
