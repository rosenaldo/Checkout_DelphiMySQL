...
type
  TFrmMenu = class(TForm)
    ...
    procedure ConfiguraoBancodeDados1Click(Sender: TObject);
  private
...
uses Usuarios, Funcionarios, Cargos, DM.Model, Fornecedores, Produtos,
  ...
  Login, EMPRESA, GerarOS.View, OrdemDeServico.View, ConexaoBD.View;
...
procedure TFrmMenu.ConfiguraoBancodeDados1Click(Sender: TObject);
begin
